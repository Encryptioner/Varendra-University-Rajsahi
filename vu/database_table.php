...
echo "<br>";
// sql to create table
$sql = "CREATE TABLE IF NOT EXISTS sem_1(
...
if (mysqli_query($con, $sql)) {
    echo "Table sem_1 created successfully";
} else {
    echo "Error creating table: " . mysqli_error($con);
}
echo "<br>";
...
// sql to create table
$sql = "CREATE TABLE IF NOT EXISTS CSE_1100 (
q_no INT PRIMARY KEY,
q VARCHAR(250) NOT NULL,
o_1 VARCHAR(50) NOT NULL,
o_2 VARCHAR(50) NOT NULL,
...
if (mysqli_query($con, $sql)) {
    echo "Table CSE_1100 created successfully";
} else {
    echo "Error creating table: " . mysqli_error($con);
}
