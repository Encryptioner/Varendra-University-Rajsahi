...
<?php
	...
	if(isset($_GET['msgr']))
	{
		...
		{
		?>
		<h3 style = "color:red; text-align:center;">Sorry Registered ID. Try Another.</h3>
		<?php		
		}
		if($message == 1)
		{
		?>
		<h3 style = "color:red; text-align:center;">Sorry ID can't contain any space. Try Another.</h3>
		<?php		
		}
	}
?>
	...
	<table style = "margin-left:auto; margin-right:auto; width:400px;">				
	   ...
	   <tbody>
		...
		<tr> 
		   <td> ID </td>
		   <td> <input type="text" name="username" required autocomplete="off" placeholder = "Enter ID"> </td>
		</tr>
